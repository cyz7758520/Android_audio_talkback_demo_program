...
public class TkbkNtwk //对讲网络。
{
    ...
    public class CnctInfo //连接信息。
    {
        ...
        public int m_LastSendAdoInptFrmIsAct; //存放最后一个发送的音频输入帧有无语音活动，为1表示有语音活动，为0表示无语音活动。
        public int m_LastSendAdoInptFrmTimeStamp; //存放最后一个发送音频输入帧的时间戳。
        public int m_LastSendVdoInptFrmTimeStamp; //存放最后一个发送视频输入帧的时间戳。
    ...
    public CnctInfo CnctInfoInit( int IsSrvrOrClntCnct, int IsTcpOrAudpPrtcl, String RmtNodeNameStrPt, String RmtNodeSrvcStrPt, TcpClntSokt TcpClntSoktPt, long AudpClntCnctIdx, int CurCnctSts )
    {
        ...
        Out:
        {
            if( m_CnctInfoCntnrPt.size() < m_MaxCnctNum ) //如果未达到最大连接数。
            {
    ...
    //连接信息发送对讲模式包。
    public int CnctInfoSendTkbkModePkt( CnctInfo CnctInfoPt, int LclTkbkMode )
    {
        int p_Rslt = -1; //存放本函数的执行结果，为0表示成功，为非0表示失败。
        ...
        Out:
        {
            ...
            if( CnctInfoSendPkt( CnctInfoPt, m_NtwkMediaPocsThrdPt.m_TmpBytePt, 2, 1, 1, m_NtwkMediaPocsThrdPt.m_ErrInfoVstrPt ) == 0 )
            {
                if( m_NtwkMediaPocsThrdPt.m_IsPrintLogcat != 0 ) Log.i( m_NtwkMediaPocsThrdPt.m_CurClsNameStrPt, "网络媒体处理线程：对讲网络：连接" + CnctInfoPt.hashCode() + "：发送一个对讲模式包成功。对讲模式：" + NtwkMediaPocsThrd.m_TkbkModeStrArrPt[ LclTkbkMode ] );
            }
            else
            {
    ...
    public void CnctInfoUpdtLclTkbkMode( CnctInfo CnctInfoPt, int LclTkbkMode )
    {
        ...
        if( m_CurActCnctInfoPt == CnctInfoPt ) //如果该连接信息为当前激活的连接信息。
        {
            m_NtwkMediaPocsThrdPt.UserCnctLclTkbkMode( CnctInfoPt, 0, CnctInfoPt.m_LclTkbkMode );
        }
        else //如果该连接信息不为当前激活的连接信息。
        {
            if( CnctInfoPt.m_LclTkbkMode != NtwkMediaPocsThrd.TkbkMode.None ) //如果该连接信息的本端对讲模式不为挂起。
            {
                m_NtwkMediaPocsThrdPt.UserCnctLclTkbkMode( CnctInfoPt, 1, CnctInfoPt.m_LclTkbkMode );
            }
        ...
        CnctInfoSendTkbkModePkt( CnctInfoPt, CnctInfoPt.m_LclTkbkMode ); //发送对讲模式包。
    }
    ...
    public void CnctInfoUpdtRmtTkbkMode( CnctInfo CnctInfoPt )
    {
        ...
        Out:
        {
            if( m_CurActCnctInfoPt == CnctInfoPt ) //如果该连接信息为当前激活的连接信息。
            {
                m_NtwkMediaPocsThrdPt.UserCnctRmtTkbkMode( CnctInfoPt, 0, CnctInfoPt.m_RmtTkbkMode );
            }
            else //如果该连接信息不为当前激活的连接信息。
            {
                if( CnctInfoPt.m_RmtTkbkMode != NtwkMediaPocsThrd.TkbkMode.None ) //如果该连接信息的远端对讲模式不为挂起。
                {
                    m_NtwkMediaPocsThrdPt.UserCnctRmtTkbkMode( CnctInfoPt, 1, CnctInfoPt.m_RmtTkbkMode );
                }
    ...
    public void CnctInfoAllUpdtRmtTkbkMode()
    {
        ...
        Out:
        {
            for( int p_CnctInfoLstNum = 0; p_CnctInfoLstNum < m_CnctInfoCntnrPt.size(); p_CnctInfoLstNum++ )
            {
                CnctInfo p_CnctInfoTmpPt = m_CnctInfoCntnrPt.get( p_CnctInfoLstNum );
    ...
    public void CnctInfoAct( CnctInfo CnctInfoPt )
    {
        ...
        Out:
        {
            if( m_CurActCnctInfoPt != CnctInfoPt ) //如果当前激活的连接信息与要激活的连接信息不一致。
            {
                ...
                {
                    p_CnctInfoTmpPt = m_CurActCnctInfoPt;
                    m_CurActCnctInfoPt = null; //设置当前激活的连接信息。
                    m_NtwkMediaPocsThrdPt.UserCnctAct( p_CnctInfoTmpPt, 0 ); //调用用户定义的连接激活函数。
                    if( p_CnctInfoTmpPt.m_CurCnctSts == NtwkMediaPocsThrd.CnctSts.Cnct )
                    {
                        CnctInfoSendTkbkModePkt( p_CnctInfoTmpPt, NtwkMediaPocsThrd.TkbkMode.None ); //发送对讲模式包。
                        CnctInfoUpdtRmtTkbkMode( p_CnctInfoTmpPt ); //连接信息更新远端对讲模式。
                    }
                }
                ...
                if( CnctInfoPt != null ) //如果要激活的连接信息不为空。
                {
                    ...
                    m_NtwkMediaPocsThrdPt.UserCnctAct( m_CurActCnctInfoPt, 1 ); //调用用户定义的连接激活函数。
                    if( m_CurActCnctInfoPt.m_CurCnctSts == NtwkMediaPocsThrd.CnctSts.Cnct ) CnctInfoUpdtLclTkbkMode( m_CurActCnctInfoPt, m_NtwkMediaPocsThrdPt.m_LclTkbkMode ); //如果连接状态为已连接，就连接信息更新本端对讲模式。
                    CnctInfoUpdtRmtTkbkMode( m_CurActCnctInfoPt ); //连接信息更新远端对讲模式。
    ...
    public void CnctInfoPend( CnctInfo CnctInfoPt )
    {
        ...
        Out:
        {
            ...
            {
                CnctInfoUpdtLclTkbkMode( CnctInfoPt, NtwkMediaPocsThrd.TkbkMode.None );
            }
        ...
        Out:
        {
            if( CnctInfoPt != null )
            {
                ...
                if( ( CnctInfoPt.m_IsSrvrOrClntCnct == 1 ) && ( CnctInfoPt.m_IsRecvExitPkt == 0 ) && ( CnctInfoPt.m_CurCnctSts == NtwkMediaPocsThrd.CnctSts.Tmot ) ) //如果为客户端的连接，且未接收到退出包，且当前连接状态为异常断开，就重连。
                {
                    ...
                    m_NtwkMediaPocsThrdPt.UserCnctSts( CnctInfoPt, CnctInfoPt.m_CurCnctSts ); //调用用户定义的连接状态函数。
                    ...
                    if( CnctInfoPt == m_CurActCnctInfoPt ) RecvOtptFrmReset(); //如果为当前激活的连接信息，接收输出帧重置。
                ...
                else //如果不为客户端的连接，或已接收到退出包，或当前连接状态不为异常断开，就销毁。
                {
                    ...
                    m_NtwkMediaPocsThrdPt.UserCnctDstoy( CnctInfoPt ); //调用用户定义的连接销毁函数。
                    ...
                    if( ( p_IsCurActCnctInfo != 0 ) && //如果是当前激活的连接信息。
                        ( ( m_IsAutoActCnct == 1 ) && ( !m_CnctInfoCntnrPt.isEmpty() ) ) ) //如果是自动激活连接，且还有其他连接信息。
                    {
    ...
    {
        int p_Rslt = -1; //存放本函数的执行结果，为0表示成功，为非0表示失败。
        Vstr p_SrvrUrlVstrPt = null; //存放服务端Url动态字符串的指针。
        HTString p_SrvrPrtclStrPt; //存放服务端协议动态字符串的指针。
        HTString p_SrvrNodeNameStrPt; //存放服务端节点名称动态字符串的指针。
        HTString p_SrvrNodeSrvcStrPt; //存放服务端节点服务动态字符串的指针。
        ...
        Out:
        {
            ...
            {
                p_SrvrPrtclStrPt = new HTString();
                p_SrvrNodeNameStrPt = new HTString();
                p_SrvrNodeSrvcStrPt = new HTString();
    ...
    //连接激活。
    public void CnctAct( int CnctNum )
    {
        int p_Rslt = -1; //存放本函数的执行结果，为0表示成功，为非0表示失败。
        CnctInfo p_CnctInfoTmpPt;
        ...
        Out:
        {
            if( ( CnctNum >= m_CnctInfoCntnrPt.size() ) || ( CnctNum < 0 ) )
            {
                String p_InfoStrPt = "网络媒体处理线程：对讲网络：没有序号为" + CnctNum + "的连接，无法激活。";
                if( m_NtwkMediaPocsThrdPt.m_IsPrintLogcat != 0 ) Log.e( m_NtwkMediaPocsThrdPt.m_CurClsNameStrPt, p_InfoStrPt );
                m_NtwkMediaPocsThrdPt.UserShowLog( p_InfoStrPt );
                break Out;
            }
    ...
    public void CnctDstoy( int CnctNum )
    {
        ...
        Out:
        {
            if( ( CnctNum >= m_CnctInfoCntnrPt.size() ) || ( CnctNum < 0 ) )
            {
                String p_InfoStrPt = "网络媒体处理线程：对讲网络：没有序号为" + CnctNum + "]的连接，无法删除。";
                if( m_NtwkMediaPocsThrdPt.m_IsPrintLogcat != 0 ) Log.e( m_NtwkMediaPocsThrdPt.m_CurClsNameStrPt, p_InfoStrPt );
                m_NtwkMediaPocsThrdPt.UserShowLog( p_InfoStrPt );
                break Out;
            }
                    ...
                    while( true )
                    {
                        ...
                        if( m_TcpSrvrSoktPt.Acpt( p_TcpClntSoktTmpPt, null, m_NtwkMediaPocsThrdPt.m_RmtNodeAddrPt, m_NtwkMediaPocsThrdPt.m_RmtNodePortPt, ( short ) 0, 0, m_NtwkMediaPocsThrdPt.m_ErrInfoVstrPt ) == 0 )
                        {
                            if( p_TcpClntSoktTmpPt.m_TcpClntSoktPt != 0 ) //如果用本端Tcp协议服务端套接字接受远端Tcp协议客户端套接字的连接成功。
                            {
                                ...
                                if( ( p_CnctInfoTmpPt = CnctInfoInit( 0, 0, m_NtwkMediaPocsThrdPt.m_RmtNodeAddrPt.m_Val, m_NtwkMediaPocsThrdPt.m_RmtNodePortPt.m_Val, p_TcpClntSoktTmpPt, -1, NtwkMediaPocsThrd.CnctSts.Cnct ) ) == null ) break TcpSrvrSoktAcptOut; //如果连接信息初始化失败。
                                m_NtwkMediaPocsThrdPt.UserCnctSts( p_CnctInfoTmpPt, p_CnctInfoTmpPt.m_CurCnctSts ); //调用用户定义的连接状态函数。
                                m_NtwkMediaPocsThrdPt.UserCnctLclTkbkMode( p_CnctInfoTmpPt, 0, p_CnctInfoTmpPt.m_LclTkbkMode );
                                m_NtwkMediaPocsThrdPt.UserCnctRmtTkbkMode( p_CnctInfoTmpPt, 0, p_CnctInfoTmpPt.m_RmtTkbkMode );
                ...
                AudpSrvrSoktAcptOut:
                {
                    while( true ) //循环接受远端高级Udp协议套接字的连接。
                    {
                        if( m_AudpSrvrSoktPt.Acpt( m_NtwkMediaPocsThrdPt.m_TmpHTLongPt, null, m_NtwkMediaPocsThrdPt.m_RmtNodeAddrPt, m_NtwkMediaPocsThrdPt.m_RmtNodePortPt, ( short ) 0, m_NtwkMediaPocsThrdPt.m_ErrInfoVstrPt ) == 0 )
                        {
                            ...
                            {
                                if( ( p_CnctInfoTmpPt = CnctInfoInit( 0, 1,  m_NtwkMediaPocsThrdPt.m_RmtNodeAddrPt.m_Val, m_NtwkMediaPocsThrdPt.m_RmtNodePortPt.m_Val, null, m_NtwkMediaPocsThrdPt.m_TmpHTLongPt.m_Val, NtwkMediaPocsThrd.CnctSts.Cnct ) ) == null ) break AudpSrvrSoktAcptOut; //如果连接信息初始化失败。
                                m_NtwkMediaPocsThrdPt.UserCnctSts( p_CnctInfoTmpPt, p_CnctInfoTmpPt.m_CurCnctSts ); //调用用户定义的连接状态函数。
                                m_NtwkMediaPocsThrdPt.UserCnctLclTkbkMode( p_CnctInfoTmpPt, 0, p_CnctInfoTmpPt.m_LclTkbkMode );
                                m_NtwkMediaPocsThrdPt.UserCnctRmtTkbkMode( p_CnctInfoTmpPt, 0, p_CnctInfoTmpPt.m_RmtTkbkMode );
                                if( ( m_IsAutoActCnct != 0 ) && ( m_CurActCnctInfoPt == null ) ) CnctInfoUpdtLclTkbkMode( p_CnctInfoTmpPt, m_NtwkMediaPocsThrdPt.m_LclTkbkMode );
                        ...
                        TcpClntSoktCnctOut:
                        {
                            ...
                            if( p_CnctInfoTmpPt.m_TcpClntSoktPt.WaitCnct( ( short ) 0, m_NtwkMediaPocsThrdPt.m_TmpHTIntPt, m_NtwkMediaPocsThrdPt.m_ErrInfoVstrPt ) == 0 ) //如果等待本端Tcp协议客户端套接字连接远端Tcp协议服务端套接字成功。
                            {
                                ...
                                else if( m_NtwkMediaPocsThrdPt.m_TmpHTIntPt.m_Val == TcpClntSokt.TcpCnctStsCnct ) //如果连接成功。
                                {
                                    ...
                                    m_NtwkMediaPocsThrdPt.UserCnctSts( p_CnctInfoTmpPt, p_CnctInfoTmpPt.m_CurCnctSts ); //调用用户定义的连接状态函数。
                                    if( ( m_IsAutoActCnct != 0 ) && ( m_CurActCnctInfoPt == null ) ) CnctInfoUpdtLclTkbkMode( p_CnctInfoTmpPt, m_NtwkMediaPocsThrdPt.m_LclTkbkMode ); //如果自动激活连接，且当前激活的连接信息为空，就连接信息更新本端对讲模式为实际的。
                                    else CnctInfoUpdtLclTkbkMode( p_CnctInfoTmpPt, p_CnctInfoTmpPt.m_LclTkbkMode ); //如果手动激活连接，或当前激活的连接信息不为空，就连接信息更新本端对讲模式为该连接信息的本端对讲模式，可能为挂起，也可能在重连时为其他状态。
                                    CnctInfoUpdtRmtTkbkMode( p_CnctInfoTmpPt );
                    ...
                    else //用本端高级Udp协议客户端套接字连接远端高级Udp协议服务端套接字。
                    {
                        ...
                        AudpClntSoktCnctOut:
                        {
                            if( m_NtwkMediaPocsThrdPt.m_AudpClntSoktPt == null ) //如果未初始化本端高级Udp协议客户端套接字。
                            {
                                ...
                                {
                                    String p_InfoStrPt = "网络媒体处理线程：对讲网络：初始化本端高级Udp协议客户端套接字失败。原因：" + m_NtwkMediaPocsThrdPt.m_ErrInfoVstrPt.GetStr();
                                    if( m_NtwkMediaPocsThrdPt.m_IsPrintLogcat != 0 ) Log.e( m_NtwkMediaPocsThrdPt.m_CurClsNameStrPt, p_InfoStrPt );
                                    m_NtwkMediaPocsThrdPt.UserShowLog( p_InfoStrPt );
                                    break AudpClntSoktCnctOut;
                                }
                            ...
                            ( ( p_CnctInfoTmpPt.m_IsTcpOrAudpPrtcl == 1 ) && ( p_CnctInfoTmpPt.m_IsSrvrOrClntCnct == 1 ) && ( m_NtwkMediaPocsThrdPt.m_AudpClntSoktPt.RecvApkt( p_CnctInfoTmpPt.m_AudpClntCnctIdx, m_NtwkMediaPocsThrdPt.m_TmpBytePt, m_NtwkMediaPocsThrdPt.m_TmpBytePt.length, m_NtwkMediaPocsThrdPt.m_TmpHTLongPt, null, ( short ) 0, m_NtwkMediaPocsThrdPt.m_ErrInfoVstrPt ) == 0 ) ) )
                        {
                            if( m_NtwkMediaPocsThrdPt.m_TmpHTLongPt.m_Val != -1 ) //如果用本端套接字接收一个连接的远端套接字发送的数据包成功。
                            {
                                ...
                                else if( m_NtwkMediaPocsThrdPt.m_TmpBytePt[ 0 ] == ( byte ) NtwkMediaPocsThrd.PktTyp.TkbkMode ) //如果是对讲模式包。
                                {
                                    ...
                                    if( m_NtwkMediaPocsThrdPt.m_IsPrintLogcat != 0 ) Log.i( m_NtwkMediaPocsThrdPt.m_CurClsNameStrPt, "网络媒体处理线程：对讲网络：连接" + p_CnctInfoTmpPt.hashCode() + "：接收到一个对讲模式包。对讲模式：" + NtwkMediaPocsThrd.m_TkbkModeStrArrPt[ p_CnctInfoTmpPt.m_RmtTkbkMode ] );
