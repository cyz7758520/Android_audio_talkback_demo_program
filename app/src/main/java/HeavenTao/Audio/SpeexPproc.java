...
public class SpeexPproc
{
    ...
    //创建并初始化Speex预处理器。
    public native int Init( int SamplingRate, int FrameLen, int IsUseNs, int NoiseSupes, int IsUseDereverb, int IsUseVad, int VadProbStart, int VadProbCont, int IsUseAgc, int AgcLevel, int AgcIncrement, int AgcDecrement, int AgcMaxGain, VarStr ErrInfoVarStrPt );
