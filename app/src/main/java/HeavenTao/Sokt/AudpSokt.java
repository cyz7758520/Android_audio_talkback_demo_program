...
public class AudpSokt
{
	...
	public class CnctSts
	{
		...
		public static final int Tmot = 2; //连接状态：超时未接收任何数据包。异常断开。
		public static final int Dsct = 3; //连接状态：已断开。本端或远端正常断开。
	}
