...
public class MyNtwkMediaPocsThrd extends NtwkMediaPocsThrd //我的网络媒体处理线程。
{
    ...
    //用户定义的连接初始化函数。
    @Override public void UserCnctInit( TkbkNtwk.CnctInfo CnctInfoPt, int IsTcpOrAudpPrtcl, String RmtNodeNameStrPt, String RmtNodeSrvcStrPt )
    {
    ...
    @Override public void UserCnctSts( TkbkNtwk.CnctInfo CnctInfoPt, int CurCnctSts )
    {
        ...
        {
            m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, null, "等待远端接受连接", "" );
        }
        else if( CurCnctSts < CnctSts.Wait )
        {
            m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, null, "第" + -CurCnctSts + "次连接", "" );
        }
        else if( CurCnctSts == CnctSts.Cnct )
        {
            m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, null, "已连接", "" );
        }
        else if( CurCnctSts == CnctSts.Tmot )
        {
            m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, null, "异常断开", "" );
        }
        else if( CurCnctSts == CnctSts.Dsct )
        {
            m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, null, "已断开", "" );
        }
    }
    ...
    {
        m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, ( IsAct != 0 ) ? "⇶" : "", null, null );
    }

    //用户定义的连接本端对讲模式函数。
    @Override public void UserCnctLclTkbkMode( TkbkNtwk.CnctInfo CnctInfoPt, int IsRqirAct, int LclTkbkMode )
    {
        m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, null, ( ( IsRqirAct != 0 ) ? "请求激活" : "" ) + m_TkbkModeStrArrPt[ LclTkbkMode ], null );
    }

    //用户定义的连接远端对讲模式函数。
    @Override public void UserCnctRmtTkbkMode( TkbkNtwk.CnctInfo CnctInfoPt, int IsRqirAct, int RmtTkbkMode )
    {
        m_MainActPt.SendMainActMsg( MainAct.MainActMsgTyp.CnctLstModifyItem, CnctInfoPt.m_Num, null, null, ( ( IsRqirAct != 0 ) ? "请求激活" : "" ) + m_TkbkModeStrArrPt[ RmtTkbkMode ] );
    }
